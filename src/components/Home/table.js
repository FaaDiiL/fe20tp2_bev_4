...
function Table({ doughnut, totalAmount, setTotalAmount, onRemoveSaving }) {
        ...
        >
          <Grid item xs={12} sm={12} md={12} xl={12}>
            ...
            <Box display='flex' justify='space-between'>
              ...
              <span
                className={
                  Math.sign(cur.currPerfomanceAmount) === -1 ? 'down' : 'up'
                }
              >
                {percentButton
    ...
    <Container maxWidth='lg'>
      <ul>
        ...
        <li>
          ...
          <span className='first' style={{ textAlign: 'right' }}>
            <StyledButton onClick={handleSwitch}>% / kr</StyledButton>
          </span>
        </li>
        {showTable()}
      </ul>
